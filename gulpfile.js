...
const wbpck = function(callback) {
  ...
  let options = {
    entry:   {
      app: './frontend/js/app',
      authenticationservice: './frontend/assets/registration/app-services/authenticationservice',
      flashservice: './frontend/assets/registration/app-services/flashservice',
      user_service_localstorage: './frontend/assets/registration/app-services/user_service_localstorage',
      home_controller: './frontend/assets/registration/home/home.controller',
      login_controller: './frontend/assets/registration/login/login.controller',
      register_controller: './frontend/assets/registration/register/register.controller'
    },
    output:  {
...
gulp.task('build', gulp.series('clean', 'styles', gulp.parallel( 'webpack'), 'assets'));
